...
bool sEepromAppGetBlockFactoryLowPowerFlag(void)
{
    return stEepromAppCache.stFactory[eEepromAppBlockFactory0].bLowPowerFlag;
}
...
bool sEepromAppSetBlockFactoryModNum(u8 u8ModNum)
{
    xSemaphoreTake(stEepromAppCache.xSemBlock[eEepromAppBlockFactory], portMAX_DELAY);
...
bool sEepromAppSetBlockFactoryModType(u8 u8ModType)
{
    xSemaphoreTake(stEepromAppCache.xSemBlock[eEepromAppBlockFactory], portMAX_DELAY);
...
bool sEepromAppSetBlockFactoryMeterType(u8 u8MeterType)
{
    xSemaphoreTake(stEepromAppCache.xSemBlock[eEepromAppBlockFactory], portMAX_DELAY);
...
bool sEepromAppSetBlockFactoryTgunHighMax(u8 u8TgunHighMax)
{
    xSemaphoreTake(stEepromAppCache.xSemBlock[eEepromAppBlockFactory], portMAX_DELAY);
...
bool sEepromAppSetBlockFactorySocMax(u8 u8SocMax)
{
    xSemaphoreTake(stEepromAppCache.xSemBlock[eEepromAppBlockFactory], portMAX_DELAY);
...
bool sEepromAppSetBlockFactoryUdcOutMax(u16 u16Udc)
{
    xSemaphoreTake(stEepromAppCache.xSemBlock[eEepromAppBlockFactory], portMAX_DELAY);
...
bool sEepromAppSetBlockFactoryIdcOutMax(u16 u16Idc)
{
    xSemaphoreTake(stEepromAppCache.xSemBlock[eEepromAppBlockFactory], portMAX_DELAY);
...
bool sEepromAppSetBlockFactoryUreqNoBms(u16 u16Ureq)
{
    xSemaphoreTake(stEepromAppCache.xSemBlock[eEepromAppBlockFactory], portMAX_DELAY);
...
bool sEepromAppSetBlockFactoryIreqNoBms(u16 u16Ireq)
{
    xSemaphoreTake(stEepromAppCache.xSemBlock[eEepromAppBlockFactory], portMAX_DELAY);
...
bool sEepromAppSetBlockFactoryLowPowerFlag(bool bFlag)
{
    xSemaphoreTake(stEepromAppCache.xSemBlock[eEepromAppBlockFactory], portMAX_DELAY);
    stEepromAppCache.stFactory[eEepromAppBlockFactory0].bLowPowerFlag = bFlag;
    xSemaphoreGive(stEepromAppCache.xSemBlock[eEepromAppBlockFactory]);
