...
typedef struct
{
    ...
    bool                                bLowPowerFlag;                          //低功耗模式标志-------------设置1时，AC交流接触器会根据设计方案自行投切，以便省电
...
extern bool sEepromAppGetBlockFactoryLowPowerFlag(void);
...
extern bool sEepromAppSetBlockFactoryModNum(u8 u8ModNum);
extern bool sEepromAppSetBlockFactoryModType(u8 u8ModType);
extern bool sEepromAppSetBlockFactoryMeterType(u8 u8MeterType);
extern bool sEepromAppSetBlockFactoryTgunHighMax(u8 u8TgunHighMax);
extern bool sEepromAppSetBlockFactorySocMax(u8 u8SocMax);
extern bool sEepromAppSetBlockFactoryUdcOutMax(u16 u16Udc);
extern bool sEepromAppSetBlockFactoryIdcOutMax(u16 u16Idc);
extern bool sEepromAppSetBlockFactoryUreqNoBms(u16 u16Ureq);
extern bool sEepromAppSetBlockFactoryIreqNoBms(u16 u16Ireq);
extern bool sEepromAppSetBlockFactoryLowPowerFlag(bool bFlag);
