...
bool sBmsCcsInit(stMmeDev_t *pDev, ePileGunIndex_t eGunIndex, void (*pCbCloseGunOutput)(ePileGunIndex_t eGunIndex), void (*pCpPwmControl)(ePileGunIndex_t eGunIndex, bool bOn))
{
    ...
    //3:mme组件初始化
    sMmeInit(pMmeDev, eGunIndex, pCpPwmControl);
    
    //4:net组件初始化
    sBmsCcsNetInit(pDev->i32Index, sBmsCcsStateSwitchMmeToV2g);
    
    //5:v2g组件初始化
    sV2gOptInit(pDev->i32Index, eGunIndex, sBmsCcsStateSwitchV2gToShutdownEmg, pCpPwmControl);
