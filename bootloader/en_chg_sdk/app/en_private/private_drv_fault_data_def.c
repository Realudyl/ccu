...
stPrivDrvFaultData_t stPrivDrvFaultData[] = 
{
    ...
    {ePrivDrvFaultCode_csTimeout,                  ePrivDrvLeve1G2,  ePrivDrvSourceBms,  "csTimeout",                  "CST充电机终止充电报文超时 "},
    {ePrivDrvFaultCode_csdTimeout,                 ePrivDrvLeve1G2,  ePrivDrvSourceBms,  "csdTimeout",                 "CSD充电统计数据报文超时"},
    ...
    {ePrivDrvFaultCode_ccuImdErr,                  ePrivDrvLeve1G2,  ePrivDrvSourceCcu,  "ccuImdErr",                  "绝缘监测故障"},
