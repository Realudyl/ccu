...
//0A帧部分
extern bool sPrivDrvGetCmd0A(bool bRptFlag, stPrivDrvCmd0A_t **pCmd0A);
...
//13帧部分
extern bool sPrivDrvGetBmsRpt(u8 u8GunId, stPrivDrvCmd13_t **pBmsData);
...
//AA帧部分
extern bool sPrivDrvSetCmdAA(bool bRptFlag, u8 u8GunId, ePrivDrvCfgCmdType_t eType, ePrivDrvCmdRst_t eRst, ePrivDrvParamAddr_t eAddr, u16 u16ParamLen, const u8 *pParam, u8 u8RepeatCnt);
