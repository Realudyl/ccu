...
bool sPileCnGateParamProc001(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, u16ParamLen, pParam, 0);
}
...
bool sPileCnGateParamProc002(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, ePrivDrvCmdRstSuccess, pCmdAa->eAddr, u16ParamLen, u8Data, 0);
}
...
bool sPileCnGateParamProc018(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, 0, NULL, 0);
...
bool sPileCnGateParamProc067(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    if(pCmdAa->eType == ePrivDrvCfgCmdTypeSet)
    {
        ...
        return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, pCmdAa->u16Len, pCmdAa->u8Data, 0);
    }
    else
    {
        ...
        return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, sizeof(stPrivDrvParamDeviceType_t), (u8*)&stPrivDrvParamDeviceTypeGet, 0);
    }
}
...
bool sPileCnGateParamProc080(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    else
    {
        ...
        return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, sizeof(stPrivDrvParamSwitch_t), (u8*)&stPrivDrvParamSwitchGet, 0);
    }
}
...
bool sPileCnGateParamProc153(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    bRst = sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, u16ParamLen, (const u8 *)pRate, 0);
...
bool sPileCnGateParamProc157(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, 0, NULL, 0);
}
...
bool sPileCnGateParamProc171(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, sizeof(u16Vlue), (const u8 *)&u16Vlue, 0);
}
...
bool sPileCnGateParamProc183(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    else
    {
        ...
        return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, 4, (u8*)&u32PdcMax, 0);
    }
}
...
bool sPileCnGateParamProc198(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    else
    {
        ...
        return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, sizeof(stPrivDrvParamUdcOut_t), (u8*)&stPrivDrvParamUdcOutGet, 0);
    }
}
...
bool sPileCnGateParamProc199(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    else
    {
        ...
        return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, sizeof(stPrivDrvParamIdcOut_t), (u8*)&stPrivDrvParamIdcOutGet, 0);
    }
}
...
bool sPileCnGateParamProc200(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    else
    {
        ...
        return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, sizeof(stPrivDrvParamGunTemp_t), (u8*)&stPrivDrvParamGunTempGet, 0);
    }
}
...
bool sPileCnGateParamProc201(const stPrivDrvCmdAA_t *pCmdAa)
{
    ...
    else
    {
       ...
       return sPrivDrvSetCmd0A(false, pCmdAa->u8GunId, pCmdAa->eType, eRst, pCmdAa->eAddr, sizeof(u8), &u8SocMax, 0);
    }
}
