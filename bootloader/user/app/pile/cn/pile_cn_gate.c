...
void sPileCnGateParam(ePileGunIndex_t eGunIndex)
{
    ...
    if(sPrivDrvGetCmdAA(true, &pCmdAaRx) == true)
    {
    ...
    if((sBmsGbt15StateGet(eGunIndex) > eBmsGbt15StateCableCheck) && (bIsoFlag[eGunIndex] == true))
    {
       ...
       sPrivDrvSetCmd0A(true, u8GunId, ePrivDrvCfgCmdTypeChargSet, ePrivDrvCmdRstSuccess, ePrivDrvParamAddr202, 4, (u8*)&u32IsoOhm, 0);
    }
